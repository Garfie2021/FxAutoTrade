...
/****** Object:  Job [Data生成_10m_OANDA_Demo]    Script Date: 2018/12/20 20:38:00 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 2018/12/20 20:38:00 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Data生成_10m_OANDA_Demo', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [print]    Script Date: 2018/12/20 20:38:01 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'print', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [recu.spInsertHistory再計算_n前から_Min15]    Script Date: 2018/12/20 20:38:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [recu.spInsertHistory再計算_n前から_Hour1]    Script Date: 2018/12/20 20:38:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [recu.spUpdateWMA再計算_n前から_Min15]    Script Date: 2018/12/20 20:38:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [recu.spUpdateWMA再計算_n前から_Hour1]    Script Date: 2018/12/20 20:38:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [print2]    Script Date: 2018/12/20 20:38:01 ******/
