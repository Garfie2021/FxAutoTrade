...
DROP PROCEDURE [recu].[spInsertHistory再計算_n前から_Week1]
GO
...
CREATE PROCEDURE [recu].[spInsertHistory再計算_n前から_Week1]
	@back_Week1 int = -1,
	@max_Week1 int = 1
AS
BEGIN
	...
	begin
		...
		begin
			...
			EXECUTE [rate].[spInsertHistory_Week1] @通貨ペアNo, @StartDate, @EndDate;
