...
DROP PROCEDURE [anls].[spInsert想定売買タイミング_買いタイミングを抽出_Swap判定無し]
GO
...
CREATE PROCEDURE [anls].[spInsert想定売買タイミング_買いタイミングを抽出_Swap判定無し]
...
BEGIN
	...
	begin
		...
		FROM [hstr].[tMonth1]
		where 通貨ペアNo = @通貨ペアNo 
			and [買いWMAs2] > [買いWMAs14] and [買いWMAs2角度] > 0
