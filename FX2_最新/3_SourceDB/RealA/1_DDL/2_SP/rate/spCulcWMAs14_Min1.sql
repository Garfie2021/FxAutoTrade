...
/*
*/
DROP PROCEDURE [rate].[spCulcWMAs14_Min1]
GO
...
CREATE PROCEDURE [rate].[spCulcWMAs14_Min1]
	@通貨ペアNo	tinyint,
	@StartDate	datetime,
...
BEGIN
	...
	*/
	...
	FETCH NEXT FROM cursor_tRateHistory_Min1 INTO @日時, @買い_終値, @売り_終値;
