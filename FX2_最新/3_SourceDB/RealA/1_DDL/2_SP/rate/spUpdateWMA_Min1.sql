...
/*
*/
DROP PROCEDURE [rate].[spUpdateWMA_Min1]
GO
...
CREATE PROCEDURE [rate].[spUpdateWMA_Min1]
	@通貨ペアNo		tinyint = 34,
	@StartDate		datetime
AS
BEGIN
	...
	*/
	...
	EXECUTE [rate].[spCulcWMAs14_Min1] @通貨ペアNo, @StartDate, @買いWMAs14 OUTPUT, @売りWMAs14 OUTPUT;
