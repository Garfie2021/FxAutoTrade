...
/*
*/
DROP PROCEDURE [rate].[spCulcWMAs14_Day1]
GO
...
CREATE PROCEDURE [rate].[spCulcWMAs14_Day1]
	@通貨ペアNo	tinyint,
	@StartDate	datetime,
...
BEGIN
	...
	*/
	...
	FETCH NEXT FROM cursor_tRateHistory_Day1 INTO @日時, @買い_終値, @売り_終値;
