...
/*
*/
DROP PROCEDURE [rate].[spInsertHistory_Month1]
GO
...
CREATE PROCEDURE [rate].[spInsertHistory_Month1]
	@通貨ペアNo	tinyint = 34,
	@StartDate	datetime,
	@EndDate	datetime
AS
BEGIN
	...
	/*
	DECLARE @通貨ペアNo	tinyint = 24;
	DECLARE @StartDate	datetime = '2017/06/01 6:00:00';
	DECLARE @EndDate	datetime = '2017/07/01 6:00:00';
	*/
