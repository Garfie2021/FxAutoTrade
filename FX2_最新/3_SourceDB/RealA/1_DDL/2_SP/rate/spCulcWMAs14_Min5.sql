...
/*
*/
DROP PROCEDURE [rate].[spCulcWMAs14_Min5]
GO
...
CREATE PROCEDURE [rate].[spCulcWMAs14_Min5]
	@通貨ペアNo	tinyint,
	@StartDate	datetime,
...
BEGIN
	...
	*/
	...
	FETCH NEXT FROM cursor_tRateHistory_Min5 INTO @日時, @買い_終値, @売り_終値;
