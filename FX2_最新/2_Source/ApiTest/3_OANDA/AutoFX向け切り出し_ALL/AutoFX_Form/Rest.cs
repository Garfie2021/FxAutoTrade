...
namespace AutoFX_Form
{
    public class Rest
    {
        ...
        public static List<InstrumentOANDA> GetInstrumentsAsync(int account, List<string> fields = null, List<string> instrumentNames = null)
        {
            ...
            List<InstrumentOANDA> instruments = new List<InstrumentOANDA>();
		...
		public static List<Price> GetRatesAsync(List<InstrumentOANDA> instruments, string since = null)
		{
