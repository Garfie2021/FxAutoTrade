...
function Init()
    ...
    indicator.parameters:addInteger("LO", resources:get("param_LO"), resources:get("param_LO_D"), 1);
...
function Update(period, mode)
    ...
    if start then
        ...
        score:start(instance.parameters.SID, core.host:execute("getBidPrice"), core.host:execute("getAskPrice"), instance.parameters:getCustomParameters("SID"), instance.parameters.TM);
