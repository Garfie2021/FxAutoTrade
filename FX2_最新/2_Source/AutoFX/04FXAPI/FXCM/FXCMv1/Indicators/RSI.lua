...
function Init()
    ...
    indicator.parameters:addInteger("widthRSI", resources:get("param_widthRSI_name"), resources:get("param_widthRSI_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleRSI", resources:get("param_styleRSI_name"), resources:get("param_styleRSI_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("styleRSI", core.FLAG_LEVEL_STYLE);
    
    indicator.parameters:addGroup("Levels");
    -- Overbought/oversold level
    indicator.parameters:addInteger("overbought", resources:get("param_level_overbought_name"), resources:get("param_level_overbought_description"), 70, 0, 100);
    indicator.parameters:addInteger("oversold", resources:get("param_level_oversold_name"), resources:get("param_level_oversold_description"), 30, 0, 100);
