...
function Init()
    ...
    indicator.parameters:addColor("clrTS", resources:get("param_clrTS_name"), resources:get("param_clrTS_description"), core.rgb(255, 255, 0));
    indicator.parameters:addInteger("widthSL", resources:get("param_widthSL_name"), resources:get("param_widthSL_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleSL", resources:get("param_styleSL_name"), resources:get("param_styleSL_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("styleSL", core.FLAG_LEVEL_STYLE);

    indicator.parameters:addColor("clrKS", resources:get("param_clrKS_name"), resources:get("param_clrKS_description"), core.rgb(0, 255, 255));
    indicator.parameters:addInteger("widthTL", resources:get("param_widthTL_name"), resources:get("param_widthTL_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleTL", resources:get("param_styleTL_name"), resources:get("param_styleTL_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("styleTL", core.FLAG_LEVEL_STYLE);

    indicator.parameters:addColor("clrCS", resources:get("param_clrCS_name"), resources:get("param_clrCS_description"), core.rgb(0, 255, 0));
    indicator.parameters:addInteger("widthCS", resources:get("param_widthCS_name"), resources:get("param_widthCS_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleCS", resources:get("param_styleCS_name"), resources:get("param_styleCS_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("styleCS", core.FLAG_LEVEL_STYLE);

    indicator.parameters:addColor("clrSSA", resources:get("param_clrSSA_name"), resources:get("param_clrSSA_description"), core.rgb(255, 0, 0));
    indicator.parameters:addInteger("widthSSA", resources:get("param_widthSSA_name"), resources:get("param_widthSSA_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleSSA", resources:get("param_styleSSA_name"), resources:get("param_styleSSA_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("styleSSA", core.FLAG_LEVEL_STYLE);

    indicator.parameters:addColor("clrSSB", resources:get("param_clrSSB_name"), resources:get("param_clrSSB_description"), core.rgb(0, 0, 255));
    indicator.parameters:addInteger("widthSSB", resources:get("param_widthSSB_name"), resources:get("param_widthSSB_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleSSB", resources:get("param_styleSSB_name"), resources:get("param_styleSSB_description"), core.LINE_SOLID);
