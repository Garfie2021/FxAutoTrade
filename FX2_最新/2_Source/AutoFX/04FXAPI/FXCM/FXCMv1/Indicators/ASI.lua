...
function Init()
    ...
    indicator.parameters:addColor("clrASI", resources:get("param_clrASI_name"), resources:get("param_clrASI_description"), core.rgb(255, 0, 0));
    indicator.parameters:addInteger("widthASI", resources:get("param_widthASI_name"), resources:get("param_widthASI_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleASI", resources:get("param_styleASI_name"), resources:get("param_styleASI_description"), core.LINE_SOLID);
