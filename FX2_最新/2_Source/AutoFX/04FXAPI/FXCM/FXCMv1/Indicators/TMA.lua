...
function Init()
    ...
    indicator.parameters:addColor("clrTMA", resources:get("param_clrTMA_name"), resources:get("param_clrTMA_description"), core.rgb(0, 255, 255));
    indicator.parameters:addInteger("widthTMA", resources:get("param_widthTMA_name"), resources:get("param_widthTMA_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleTMA", resources:get("param_styleTMA_name"), resources:get("param_styleTMA_description"), core.LINE_SOLID);
