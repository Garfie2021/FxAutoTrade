...
function Init()
    ...
    indicator.parameters:addColor("JawC", resources:get("param_JawC_name"), resources:get("param_JawC_description"), core.rgb(0, 0, 255));
    indicator.parameters:addInteger("JawW", resources:get("param_JawW_name"), resources:get("param_JawW_description"), 1, 1, 5);
    indicator.parameters:addInteger("JawSt", resources:get("param_JawSt_name"), resources:get("param_JawSt_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("JawSt", core.FLAG_LEVEL_STYLE);

    indicator.parameters:addColor("TeethC", resources:get("param_TeethC_name"), resources:get("param_TeethC_description"), core.rgb(255, 0, 0));
    indicator.parameters:addInteger("TeethW", resources:get("param_TeethW_name"), resources:get("param_TeethW_description"), 1, 1, 5);
    indicator.parameters:addInteger("TeethSt", resources:get("param_TeethSt_name"), resources:get("param_TeethSt_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("TeethSt", core.FLAG_LEVEL_STYLE);

    indicator.parameters:addColor("LipsC", resources:get("param_LipsC_name"), resources:get("param_LipsC_description"), core.rgb(0, 255, 0));
    indicator.parameters:addInteger("LipsW", resources:get("param_LipsW_name"), resources:get("param_LipsW_description"), 1, 1, 5);
    indicator.parameters:addInteger("LipsSt", resources:get("param_LipsSt_name"), resources:get("param_LipsSt_description"), core.LINE_SOLID);
