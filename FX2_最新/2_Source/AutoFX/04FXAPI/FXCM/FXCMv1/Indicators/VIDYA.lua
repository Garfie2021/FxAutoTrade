...
function Init()
    ...
    indicator.parameters:addColor("V_color", resources:get("param_V_color_name"), resources:get("param_V_color_description"), core.rgb(0, 0, 255));
    indicator.parameters:addInteger("V_width", resources:get("param_V_width_name"), resources:get("param_V_width_description"), 1, 1, 5);
    indicator.parameters:addInteger("V_style", resources:get("param_V_style_name"), resources:get("param_V_style_description"), core.LINE_SOLID);
