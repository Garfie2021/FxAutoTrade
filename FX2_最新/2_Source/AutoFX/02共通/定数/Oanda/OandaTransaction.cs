...
namespace 定数
{
    // OANDARestLibrary.TradeLibrary.DataTypesのコピー

    public class OandaTransaction //: OandaResponse
    {
        ...
        public OandaTradeData tradeOpened { get; set; }
        public OandaTradeData tradeReduced { get; set; }
