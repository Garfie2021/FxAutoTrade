function Init()
    ...
    indicator.parameters:addColor("clrCHO", resources:get("param_clrCHO_name"), resources:get("param_clrCHO_description"), core.rgb(128, 128, 128));
    indicator.parameters:addInteger("widthCHO", resources:get("param_widthCHO_name"), resources:get("param_widthCHO_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleCHO", resources:get("param_styleCHO_name"), resources:get("param_styleCHO_description"), core.LINE_SOLID);
