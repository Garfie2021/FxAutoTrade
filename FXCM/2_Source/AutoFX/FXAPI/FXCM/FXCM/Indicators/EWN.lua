...
function Init()
    ...
    indicator.parameters:addColor("clrEWN", resources:get("param_clrEWN_name"), resources:get("param_clrEWN_description"), core.rgb(255, 0, 0));
    indicator.parameters:addInteger("widthEWN", resources:get("param_widthEWN_name"), resources:get("param_widthEWN_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleEWN", resources:get("param_styleEWN_name"), resources:get("param_styleEWN_description"), core.LINE_SOLID);
