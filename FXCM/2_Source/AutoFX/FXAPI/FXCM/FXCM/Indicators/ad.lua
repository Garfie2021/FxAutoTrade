function Init()
    ...
    indicator.parameters:addColor("clrAD", resources:get("param_clrAD_name"), resources:get("param_clrAD_description"), core.rgb(255, 83, 83));
    indicator.parameters:addInteger("widthAD", resources:get("param_widthAD_name"), resources:get("param_widthAD_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleAD", resources:get("param_styleAD_name"), resources:get("param_styleAD_description"), core.LINE_SOLID);
