function Init()
    ...
    indicator.parameters:addColor("GO_color", resources:get("param_GO_color_name"), resources:get("param_GO_color_description"), core.rgb(0, 255, 0));
    indicator.parameters:addColor("RO_color", resources:get("param_RO_color_name"), resources:get("param_RO_color_description"), core.rgb(255, 0, 0));
end
