...
function Init()
    ...
    indicator.parameters:addColor("GrowColor", resources:get("param_GrowColor_name"), resources:get("param_GrowColor_description"), core.rgb(0, 255, 0));
    indicator.parameters:addInteger("GrowWidth", resources:get("param_GrowWidth_name"), resources:get("param_GrowWidth_description"), 1, 1, 5);
    indicator.parameters:addInteger("GrowStyle", resources:get("param_GrowStyle_name"), resources:get("param_GrowStyle_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("GrowStyle", core.FLAG_LEVEL_STYLE);
    indicator.parameters:addColor("FallColor", resources:get("param_FallColor_name"), resources:get("param_FallColor_description"), core.rgb(255, 0, 0));
    indicator.parameters:addInteger("FallWidth", resources:get("param_FallWidth_name"), resources:get("param_FallWidth_description"), 1, 1, 5);
    indicator.parameters:addInteger("FallStyle", resources:get("param_FallStyle_name"), resources:get("param_FallStyle_description"), core.LINE_SOLID);
