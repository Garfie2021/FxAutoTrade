...
function Init()
    ...
    indicator.parameters:addColor("clrEW", resources:get("param_clrEW_name"), resources:get("param_clrEW_description"), core.rgb(0, 255, 255));
    indicator.parameters:addInteger("widthEW", resources:get("param_widthEW_name"), resources:get("param_widthEW_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleEW", resources:get("param_styleEW_name"), resources:get("param_styleEW_description"), core.LINE_SOLID);
