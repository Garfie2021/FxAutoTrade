...
function Init()
    ...
    indicator.parameters:addColor("clrUpGrow",resources:get("param_clrUpGrow_name"), resources:get("param_clrUpGrowp_description"), core.rgb(0, 255, 0));
    indicator.parameters:addColor("clrUpFall", resources:get("param_clrUpFall_name"), resources:get("param_clrUpFall_description"), core.rgb(0, 127, 0));
    indicator.parameters:addColor("clrDnGrow", resources:get("param_clrDnGrow_name"), resources:get("param_clrDnGrow_description"), core.rgb(127, 0, 0));
    indicator.parameters:addColor("clrDnFall", resources:get("param_clrDnFall_name"), resources:get("param_clrDnFall_description"), core.rgb(255, 0, 0));
end
