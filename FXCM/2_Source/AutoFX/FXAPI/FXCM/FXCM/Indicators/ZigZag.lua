...
function Init()
    ...
    indicator.parameters:addColor("Zig_color", resources:get("param_clrZig_name"), resources:get("param_clrZig_description"), core.rgb(0, 255, 0));
    indicator.parameters:addColor("Zag_color", resources:get("param_clrZag_name"), resources:get("param_clrZag_description"), core.rgb(255, 0, 0));
    indicator.parameters:addInteger("widthZigZag", resources:get("param_widthZigZag_name"), resources:get("param_widthZigZag_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleZigZag", resources:get("param_styleZigZag_name"), resources:get("param_styleZigZag_description"), core.LINE_SOLID);
