function Init()
    ...
    indicator.parameters:addInteger("N", resources:get("param_N_name"), resources:get("param_N_description"), 21, 1, 1000);
    ...
    indicator.parameters:addColor("clrCMF", resources:get("param_clrCMF_name"), resources:get("param_clrCMF_description"), core.rgb(128, 128, 128));
    indicator.parameters:addInteger("widthCMF", resources:get("param_widthCMF_name"), resources:get("param_widthCMF_description"), 1, 1, 5);
    indicator.parameters:addInteger("styleCMF", resources:get("param_styleCMF_name"), resources:get("param_styleCMF_description"), core.LINE_SOLID);
    indicator.parameters:setFlag("styleCMF", core.FLAG_LEVEL_STYLE);
    indicator.parameters:addColor("clrHU", resources:get("param_clrHU_name"), resources:get("param_clrHU_description"), core.rgb(0, 255, 0));
    indicator.parameters:addColor("clrHD", resources:get("param_clrHD_name"), resources:get("param_clrHD_description"), core.rgb(255, 0, 0));
end
