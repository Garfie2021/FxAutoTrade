UPDATE [RealA_FX_ACV].[hstr].tWeek1
 ...
 WHERE [RealA_FX_ACV].[hstr].tWeek1.[通貨ペアNo] = b.[通貨ペアNo] AND [RealA_FX_ACV].[hstr].tWeek1.[StartDate] = b.[日時]
...
UPDATE [RealA_FX_ACV].[hstr].tMonth1
 ...
 WHERE [RealA_FX_ACV].[hstr].tMonth1.[通貨ペアNo] = b.[通貨ペアNo] AND [RealA_FX_ACV].[hstr].tMonth1.[StartDate] = b.[日時]
...
UPDATE [RealA_FX_ACV].[hstr].tDay1
 ...
 WHERE [RealA_FX_ACV].[hstr].tDay1.[通貨ペアNo] = b.[通貨ペアNo] AND [RealA_FX_ACV].[hstr].tDay1.[StartDate] = b.[日時]
...
UPDATE [RealA_FX_ACV].[hstr].tHour6
 ...
 WHERE [RealA_FX_ACV].[hstr].tHour6.[通貨ペアNo] = b.[通貨ペアNo] AND [RealA_FX_ACV].[hstr].tHour6.[StartDate] = b.[日時]
...
UPDATE [RealA_FX_ACV].[hstr].tMin30
 ...
 WHERE [RealA_FX_ACV].[hstr].tMin30.[通貨ペアNo] = b.[通貨ペアNo] AND [RealA_FX_ACV].[hstr].tMin30.[StartDate] = b.[日時]
...
UPDATE [RealA_FX_ACV].[hstr].tHour1 
 ...
 WHERE [RealA_FX_ACV].[hstr].tHour1.[通貨ペアNo] = b.[通貨ペアNo] AND [RealA_FX_ACV].[hstr].tHour1.[StartDate] = b.[日時]
