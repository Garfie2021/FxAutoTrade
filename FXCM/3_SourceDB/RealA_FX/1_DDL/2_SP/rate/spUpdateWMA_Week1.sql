...
/*
*/
DROP PROCEDURE [rate].[spUpdateWMA_Week1]
GO
...
CREATE PROCEDURE [rate].[spUpdateWMA_Week1]
	@通貨ペアNo		tinyint = 34,
	@StartDate		datetime
AS
BEGIN
	...
	*/
	...
	EXECUTE [rate].[spCulcWMAs2_Week1] @通貨ペアNo, @StartDate, @買いWMAs2 OUTPUT, @売りWMAs2 OUTPUT;
	...
	EXECUTE [rate].[spCulcWMAs14_Week1] @通貨ペアNo, @StartDate, @買いWMAs14 OUTPUT, @売りWMAs14 OUTPUT;
