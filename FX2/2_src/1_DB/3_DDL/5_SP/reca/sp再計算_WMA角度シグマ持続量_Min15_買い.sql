...
/*
*/
DROP PROCEDURE [reca].[sp再計算_WMA角度シグマ持続量_Min15_買い]
GO
...
CREATE PROCEDURE [reca].[sp再計算_WMA角度シグマ持続量_Min15_買い]
...
BEGIN
	...
	*/
	...
	FETCH NEXT FROM cursor_tRateHistory_Min15_シグマ INTO @通貨ペアNo, @StartDate, @買いRate_終値, @買いWMAs2角度;

	WHILE @@FETCH_STATUS = 0
	BEGIN
		EXECUTE [rate].[spCulcWMAs2角度シグマ持続量_Min15_買い] @通貨ペアNo, @StartDate, @買いRate_終値, @買いWMAs2角度, 
