...
/*
*/
DROP PROCEDURE [reca].[sp再計算_WMA角度シグマ持続量_Min15_売り]
GO
...
CREATE PROCEDURE [reca].[sp再計算_WMA角度シグマ持続量_Min15_売り]
...
BEGIN
	...
	*/
	...
	FETCH NEXT FROM cursor_tRateHistory_Min15_シグマ INTO @通貨ペアNo, @StartDate, @売りRate_終値, @売りWMAs2角度;

	WHILE @@FETCH_STATUS = 0
	BEGIN
		EXECUTE [rate].[spCulcWMAs2角度シグマ持続量_Min15_売り] @通貨ペアNo, @StartDate, @売りRate_終値, @売りWMAs2角度, 
	...
	CLOSE cursor_tRateHistory_Min15_シグマ;
	DEALLOCATE cursor_tRateHistory_Min15_シグマ;
END
GO
/*
*/
