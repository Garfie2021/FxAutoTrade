...
DROP PROCEDURE [reca].[sp再計算_WMA角度_Min15]
GO
...
CREATE PROCEDURE [reca].[sp再計算_WMA角度_Min15]
...
BEGIN
	...
	begin
		...
		begin
			...
			EXECUTE [rate].[spCulcWMAs2角度_Min15] @通貨ペアNo, @StartDate, @買いWMAs2, @売りWMAs2, @買いWMAs2角度 OUTPUT, @売りWMAs2角度 OUTPUT;
