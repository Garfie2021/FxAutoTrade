...
/*
*/
DROP PROCEDURE [rate].[spCulcWMAs2角度シグマ持続量_Min5_買い]
GO
...
CREATE PROCEDURE [rate].[spCulcWMAs2角度シグマ持続量_Min5_買い]
	@通貨ペアNo				tinyint,
	@StartDate				datetime,
...
BEGIN
	...
	*/
	...
	FETCH NEXT FROM cursor_tRateHistory_Min5 INTO @買いRate_終値, @買いWMAs2角度;
