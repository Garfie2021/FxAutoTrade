...
DROP PROCEDURE [rate].[spCulcWMAs2_Min1]
GO
...
CREATE PROCEDURE [rate].[spCulcWMAs2_Min1]
	@通貨ペアNo	tinyint,
	@StartDate	datetime,
...
BEGIN
	...
	*/
	...
	declare cursor_tRateHistory_1m cursor for
	...
	open cursor_tRateHistory_1m;

	FETCH NEXT FROM cursor_tRateHistory_1m INTO @日時, @買いRate_終値, @売りRate_終値;
	...
	CLOSE cursor_tRateHistory_1m;
	DEALLOCATE cursor_tRateHistory_1m;
