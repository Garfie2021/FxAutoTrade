...
/*
*/
DROP PROCEDURE [rate].[spCulcWMAs2角度シグマ持続量_Min15_買い]
GO
...
CREATE PROCEDURE [rate].[spCulcWMAs2角度シグマ持続量_Min15_買い]
	@通貨ペアNo				tinyint,
	@StartDate				datetime,
...
BEGIN
	...
	*/
	...
	FETCH NEXT FROM cursor_tRateHistory_Min15 INTO @買いRate_終値, @買いWMAs2角度;
