...
/*
*/
DROP PROCEDURE [rate].[spCulcWMAs2角度シグマ持続量_Min15_売り]
GO
...
CREATE PROCEDURE [rate].[spCulcWMAs2角度シグマ持続量_Min15_売り]
	@通貨ペアNo				tinyint,
	@StartDate				datetime,
...
BEGIN
	...
	*/
	...
	FETCH NEXT FROM cursor_tRateHistory_Min15 INTO @売りRate_終値, @売りWMAs2角度;
