...
namespace FXCM
{
	public static class FXCMConst
    {
		...
		static FXCMConst()
        {
			通貨ペア = new string[通貨ペア数];
			通貨ペア[FXCMConst.DGVRowNo_AUD_CAD] = FXCMConst.AUD_CAD;
			通貨ペア[FXCMConst.DGVRowNo_AUD_CHF] = FXCMConst.AUD_CHF;
			通貨ペア[FXCMConst.DGVRowNo_AUD_JPY] = FXCMConst.AUD_JPY;
			通貨ペア[FXCMConst.DGVRowNo_AUD_NZD] = FXCMConst.AUD_NZD;
			通貨ペア[FXCMConst.DGVRowNo_AUD_USD] = FXCMConst.AUD_USD;
			通貨ペア[FXCMConst.DGVRowNo_CAD_CHF] = FXCMConst.CAD_CHF;
			通貨ペア[FXCMConst.DGVRowNo_CAD_JPY] = FXCMConst.CAD_JPY;
			通貨ペア[FXCMConst.DGVRowNo_CHF_JPY] = FXCMConst.CHF_JPY;
			通貨ペア[FXCMConst.DGVRowNo_EUR_AUD] = FXCMConst.EUR_AUD;
			通貨ペア[FXCMConst.DGVRowNo_EUR_CAD] = FXCMConst.EUR_CAD;
			通貨ペア[FXCMConst.DGVRowNo_EUR_CHF] = FXCMConst.EUR_CHF;
			通貨ペア[FXCMConst.DGVRowNo_EUR_GBP] = FXCMConst.EUR_GBP;
			通貨ペア[FXCMConst.DGVRowNo_EUR_JPY] = FXCMConst.EUR_JPY;
			通貨ペア[FXCMConst.DGVRowNo_EUR_NZD] = FXCMConst.EUR_NZD;
			通貨ペア[FXCMConst.DGVRowNo_EUR_TRY] = FXCMConst.EUR_TRY;
			通貨ペア[FXCMConst.DGVRowNo_EUR_USD] = FXCMConst.EUR_USD;
			通貨ペア[FXCMConst.DGVRowNo_GBP_AUD] = FXCMConst.GBP_AUD;
			通貨ペア[FXCMConst.DGVRowNo_GBP_CAD] = FXCMConst.GBP_CAD;
			通貨ペア[FXCMConst.DGVRowNo_GBP_CHF] = FXCMConst.GBP_CHF;
			通貨ペア[FXCMConst.DGVRowNo_GBP_JPY] = FXCMConst.GBP_JPY;
			通貨ペア[FXCMConst.DGVRowNo_GBP_NZD] = FXCMConst.GBP_NZD;
			通貨ペア[FXCMConst.DGVRowNo_GBP_USD] = FXCMConst.GBP_USD;
			通貨ペア[FXCMConst.DGVRowNo_HKD_JPY] = FXCMConst.HKD_JPY;
			通貨ペア[FXCMConst.DGVRowNo_NOK_JPY] = FXCMConst.NOK_JPY;
			通貨ペア[FXCMConst.DGVRowNo_NZD_CAD] = FXCMConst.NZD_CAD;
			通貨ペア[FXCMConst.DGVRowNo_NZD_CHF] = FXCMConst.NZD_CHF;
			通貨ペア[FXCMConst.DGVRowNo_NZD_JPY] = FXCMConst.NZD_JPY;
			通貨ペア[FXCMConst.DGVRowNo_NZD_USD] = FXCMConst.NZD_USD;
			通貨ペア[FXCMConst.DGVRowNo_SEK_JPY] = FXCMConst.SEK_JPY;
			通貨ペア[FXCMConst.DGVRowNo_SGD_JPY] = FXCMConst.SGD_JPY;
			通貨ペア[FXCMConst.DGVRowNo_TRY_JPY] = FXCMConst.TRY_JPY;
			通貨ペア[FXCMConst.DGVRowNo_USD_CAD] = FXCMConst.USD_CAD;
			通貨ペア[FXCMConst.DGVRowNo_USD_CHF] = FXCMConst.USD_CHF;
			通貨ペア[FXCMConst.DGVRowNo_USD_HKD] = FXCMConst.USD_HKD;
			通貨ペア[FXCMConst.DGVRowNo_USD_JPY] = FXCMConst.USD_JPY;
			通貨ペア[FXCMConst.DGVRowNo_USD_TRY] = FXCMConst.USD_TRY;
			通貨ペア[FXCMConst.DGVRowNo_USD_SGD] = FXCMConst.USD_SGD;
			通貨ペア[FXCMConst.DGVRowNo_USD_ZAR] = FXCMConst.USD_ZAR;
			通貨ペア[FXCMConst.DGVRowNo_ZAR_JPY] = FXCMConst.ZAR_JPY;
			通貨ペア[FXCMConst.DGVRowNo_XAU_USD] = FXCMConst.XAU_USD;
			通貨ペア[FXCMConst.DGVRowNo_JPN225] = FXCMConst.JPN225;
			通貨ペア[FXCMConst.DGVRowNo_US30] = FXCMConst.US30;
			通貨ペア[FXCMConst.DGVRowNo_USDOLLAR] = FXCMConst.USDOLLAR;
			通貨ペア[FXCMConst.DGVRowNo_USOil] = FXCMConst.USOil;
		}
